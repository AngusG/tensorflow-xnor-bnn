all:
	...
	g++ -std=c++11 -shared -o libs/gemm_op.so src/gemm_op.cc -D_GLIBCXX_USE_CXX11_ABI=0 obj/xnor_gemm_kernel.cu.o obj/base_gemm_kernel.cu.o -I ${TF_INC} -fPIC -lcudart -L ${CUDA_ROOT}/lib64
